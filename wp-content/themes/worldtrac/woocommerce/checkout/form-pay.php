	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'worldtrac' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'worldtrac' ); ?></th>
			</tr>
		</thead>
		<tbody>
